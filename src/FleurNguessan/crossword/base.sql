...
CREATE TABLE `GRID` (
  ...
  `nom_grille` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL,
  `largeur` int NOT NULL,
  `hauteur` int NOT NULL,
  `controle` varchar(2000) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL
...
INSERT INTO `GRID` (`numero_grille`, `nom_grille`, `largeur`, `hauteur`, `controle`) VALUES
...
--
ALTER TABLE `GRID`
  ADD PRIMARY KEY (`numero_grille`);
COMMIT;

--
-- Structure de la table `CROSSWORD`
--

CREATE TABLE `CROSSWORD` (
  `numero_mot` int NOT NULL,
  `definition` varchar(256) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL,
  `horizontal` tinyint NOT NULL,
  `ligne` int NOT NULL,
  `colonne` int NOT NULL,
  `solution` varchar(64) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL,
  `numero_grille` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;

--
-- Déchargement des données de la table `CROSSWORD`
--

INSERT INTO `CROSSWORD` (`numero_mot`, `definition`, `horizontal`, `ligne`, `colonne`, `solution`, `numero_grille`) VALUES
...
--
-- Index pour la table `CROSSWORD`
--
ALTER TABLE `CROSSWORD`
  ADD PRIMARY KEY (`numero_mot`),
  ADD KEY `FK1_MOT` (`numero_grille`);

--
-- AUTO_INCREMENT pour la table `CROSSWORD`
--
ALTER TABLE `CROSSWORD`
  MODIFY `numero_mot` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=490;
COMMIT;
